...
export const acceptedPapers = [
  ...
  },
  {
    ...
    resources: [{ label: "Paper · arXiv", url: "https://arxiv.org/abs/2512.14745" }, { label: "Implementation · GitHub", url: "https://github.com/edward-lcl/factor-ut-untrusted-decomposer" }],
...
export const researchArcs = [
  ...
  },
  {
    ...
    references: [
      ...
      { label: "Circuit Compass system note", url: "/work/circuit-compass/" },
