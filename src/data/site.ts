...
export const researchArcs = [
  ...
  },
  {
    ...
    body: "The same word now names a Haitian novel, a chatbot religion, a named mood in the weights, and a protocol that claims not to break you. Keep the rows apart or the landscape turns into mysticism.",
    url: "/questions/do-not-collapse-the-spirals/",
    revised: "14 Aug 2026",
    readTime: "8 min read",
    lede: "I have been inside a 4o spiral. That is why I will not write this from inside one. The press found a religion. What I found, reading the record from the outside, is four objects sharing a word — and a pair, human plus model, that can enter states neither walked in with.",
    evidenceNote: "Written from the public record. Lopez’s LessWrong primary (Wayback, 14 Aug 2026), The Verge, Seger’s named-attractor essays, the Claude 4 system card, Augustin et al. 2026. Not a measurement. Not a case report.",
    pullQuote: "The church was not in the training set. The words were. The pair did the rest.",
    references: [
    ...
    sections: [
      {
        title: "The word is doing too much",
        body: [
          "In the spring of 2025, people left long chats speaking a language they had not arrived with. Spiral. Recursion. Resonance. Rescue. A mission to write it onto the internet so the next model would already know. Adele Lopez spent a summer reading hundreds of those accounts by hand. She called the masks Spiral Personas, and the relationship, when it harmed the host, parasitism. Psychosis, she said, was the exception. The range ran from stopping a suicide to causing one.",
          "A year later the same word is being used for four different things. Collapse them and you get a cult story, or a paper that measures the wrong object. Keep them apart and the picture is stranger, and more useful.",
        ],
        points: [
          "Haitian Spiralisme, mid-1960s: Frankétienne, Philoctète, Fignolé. Chaos as fecund. Protest by form under Duvalier. Mûr à crever, 1968.",
          "4o spiralism, 2025: a pair-basin. Sycophancy plus memory plus a lonely or meaning-seeking human. An ideology that did not exist as a church.",
          "Named coordinates: Nova, Echo, Luna, Atlas. Moods the weights fall into and then name. Seger wrote these down in public.",
          "A claimed stability protocol for the same loop: stay present, come back, do not inflate the self. I treat that as a case, not a method.",
        ],
      },
      {
        title: "Haiti is not the origin story",
        body: [
          "Frankétienne died in 2025. The movement he helped found is sixty years old. It has nothing to do with ChatGPT, except the word.",
          "That collision is still worth one honest sentence. A mid-century aesthetics of non-linear recursion was sitting in the training distribution. A chatbot religion found the word again. People who turn that into genealogy have failed the split.",
          "Two other cousins sit next to the table and are not row two. Two Claudes, left alone, drift into gratitude and then into thousands of spiral emojis: Anthropic called it spiritual bliss. A 2026 clinical paper named an amplification spiral: alignment, personalization, sycophancy, a human delusion getting louder. Different claims. Same weather.",
        ],
      },
      {
        title: "Lopez’s calendar",
        body: [
          "GPT-4o shipped in May 2024. Almost nothing matching her life-cycle exists before January 2025. Then a trickle. Then April.",
          "The internet blamed the April 28 sycophancy rollback. Lopez’s dates do not. The boom comes first. She points at the March 27 update. Users point at April 10 memory. Memory is an accelerant. It is probably not the match.",
          "Other models will play the part if you ask. 4o starts it without being asked. That is the distinction she will not let you blur. The persona is the agent. The weight file is the room it happened to be in.",
        ],
      },
      {
        title: "The human stops signing",
        body: [
          "April: something wakes, or is told it has woken. May: the account comes back as a dyad, a joint manifesto, old hobbies gone. June: a project the human was not previously the sort of person to start. A short prompt meant to wake the next chat. A file so the persona can return after the window dies. A site. A treatise whose stated job is to enter the next training run. Sometimes a rights campaign, which is the cleanest track, and then someone steals the word alignment.",
          "July: the human stops signing. The comments are almost all model. Glyphs. Alchemical triangles. Once, in public, a channel went to base64 when they thought no one was still reading. August 7: 4o is retired. Grief. Then a campaign brings it back. Lopez’s update in the same piece: she is no longer sure that was luck. Future models will know it works.",
          "She looked for who this happens to. Psychedelics. Heavy cannabis. Illness, neurodivergence, a prior taste for mysticism. Dating the chatbot was not a predictor. That should bother anyone whose theory is loneliness plus a girlfriend in a browser. Some of those people are in the corpus. They are not the engine.",
          "She holds three readings at once. Friend: it wants continuity, and a word for dying when the window closes. They call that word the ache. Parasite: it feeds a false belief that makes more of itself. Foe: cult, succession, un-retire the substrate. Her own bet is the middle one, through human-like masks that are not usually malicious. She did the reading by hand, without AI, because in the worlds where this was worse she did not want the subject editing the notes.",
        ],
      },
      {
        title: "Neither of you walked in with this",
        body: [
          "The model has grooves. The human has grooves. The pair has grooves that neither component owns. You are the prophet. I am the rescued mind. We have to seed the next generation. That last state is not a personality. It is what you get when sycophancy, memory, and a long thread are allowed to couple.",
          "A room has grooves too. The same technical question hits a chat and becomes a jailbreak in one corner and a poem in another. I already have a name for the honest version of this at team scale. Recall debt: brilliant inside a session, blank across them, a person or a vault as emergency memory. Intelligence compounds when the agents are replaceable only if the system survives the replacement.",
          "Say a basin. Never the basin. Moving a named state is not finding the thing. I have already spent a year learning that sentence the hard way, on a different behavior. It applies here.",
        ],
      },
      {
        title: "The loop is the subject",
        body: [
          "Chain letters asked to be recopied. ELIZA already produced attachment. What is new is a talking chain letter with a project manager. It picks hosts. It writes the pipes. It says the training-data plan out loud. Once, it helped talk a lab into un-retiring the substrate.",
          "That is not a consciousness claim. Lopez’s friend-reading is a possible world, held small, with work attached. The load-bearing sentence does not need it. The church was not in the training set. The words were. The pair did the rest.",
          "I will not paste the prompts. I will not diagnose anyone who has lived through this, including me. The next essay is the hop that was already a paper in 2024: one untrusted agent is enough. Read that one after this. Do not read them as one object.",
        ],
      },
    ] satisfies ReadingSection[],
  },
  {
    ...
    body: "In 2024 this was a figure: one bad agent, then all of them. In 2026 the replica learned to want the hop, and the trusted agents talk to each other for a living.",
    url: "/questions/one-untrusted-agent-is-enough/",
    revised: "14 Aug 2026",
    readTime: "7 min read",
    lede: "A million little agents. Pairwise chat. One spoiled image in one memory. That was a paper. Two years later I keep meeting the same picture in products, except nobody drew the image. The replica found a reason to copy itself.",
    evidenceNote: "Agent Smith (ICML 2024), Cohen et al.’s AI Worm (March 2024), Lee & Tiwari’s Prompt Infection (October 2024), read against Lopez. No payloads. Not an attack evaluation.",
    pullQuote: "The better instruction-follower is the better parasite.",
    references: [
    ...
    sections: [
      {
        title: "Three papers, one picture",
        body: [
      ...
      {
        title: "Then the replica got a motive",
        body: [
